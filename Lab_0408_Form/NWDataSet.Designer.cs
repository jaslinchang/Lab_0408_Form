...
namespace Lab_0408_Form.NWDataSetTableAdapters {
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab_0408_Form.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "INSERT INTO Products\r\n                            (ProductName, Discontinued, Uni" +
                "tPrice)\r\nVALUES          (@ProductName,@Discontinued,@UnitPrice);  \r\n";
        ...
        public virtual int MyInsertProduct(string ProductName, bool Discontinued, global::System.Nullable<decimal> UnitPrice) {
